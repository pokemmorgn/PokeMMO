...
export class ConnectionManager {
  ...
  // ✅ Configuration du système ping/pong
  setupPingPong() {
    ...
    // Setup NetworkManager pong listener
    ...
    console.log(`📡 [ConnectionManager] Ping/Pong configuré (${this.pingInterval}ms)`);
  }
