...
import { integrateStarterSelectorToScene } from '../../components/StarterSelector.js'; // ← AJOUTER CETTE LIGNE
...
export class BaseZoneScene extends Phaser.Scene {
  constructor(sceneKey, mapKey) {
    ...
    // 🎯 NOUVEAU: Système de starter
    this.starterSystemInitialized = false; // ← AJOUTER CETTE LIGNE
