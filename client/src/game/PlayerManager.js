...
player.body.debugShowBody = true; player.body.debugBodyColor = 0xff0000;
 ...
 createAnimations() {
  ...
  // BAS : frames 0,1,2 (0=marche, 1=idle, 2=marche)
  if (!anims.exists('walk_down')) {
    anims.create({
      ...
      frames: [
        ...
        { key: 'BoyWalk', frame: 1 },
        { key: 'BoyWalk', frame: 2 },
        { key: 'BoyWalk', frame: 1 }, // pour boucler: idle entre les pas
      ],
      frameRate: 8,
      repeat: -1,
    });
  ...
  if (!anims.exists('walk_up')) {
    anims.create({
      ...
      frames: [
        { key: 'BoyWalk', frame: 9 },
        { key: 'BoyWalk', frame: 10 },
        { key: 'BoyWalk', frame: 11 },
        { key: 'BoyWalk', frame: 10 },
      ],
      frameRate: 8,
      repeat: -1,
  ...
  // IDLE (toujours la frame centrale de chaque direction)
  ...
  console.log("🎞️ Animations BoyWalk créées (3x4, mapping RPG Maker avec idle au milieu)");
}
